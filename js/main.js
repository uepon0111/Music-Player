...
function _syncViewportVars() {
  // Use visualViewport.height to get the actual visible area (excludes browser chrome on mobile)
...
// Sync viewport immediately and again after a short delay (iOS fix)
_syncViewportVars();
setTimeout(_syncViewportVars, 300);
